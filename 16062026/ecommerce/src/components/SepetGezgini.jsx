...
// ilerleme çubuğunun yüzde kaç dolacağını hesapladık Math.min ile barın %100ü taşmasını engelledik
...
// sepet açık mı kapalı mı durumuna göre css sınıf adı
      ...
      <div className={drawerClass}>
        <div>
          ...
          <div className="sepet-liste-alani">
            {sepet.length === 0 ? (// sepet dizisinin içi boşsa kullanıcıya boş mesajı gösteren şartı açtık
                  ...
                  <div className="sepet-eleman-bilgi">
                    ...
                    <div className="sepet-adet-kontrolleri">
                      <button
                        ...
                        {/* eksi butonuna basınca adet güncelleme fonksiyonuna mevcut adedin 1 eksiğini yolladık */}
                      ...
                      <button
                        onClick={() => onAdetGuncelle(item.id, item.adet + 1)}{/* artı butonuna basınca mevcut adedin 1 fazlasını yukarı yolladık */}
                        className="sepet-adet-btn"
                      >
                        +
                      </button>
        ...
        {sepet.length > 0 && ( // sepet doluysa en alttaki fatura ve ödeme panelini ekrana getiren şartı koyduk
